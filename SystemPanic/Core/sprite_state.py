...
def do_sprites_collide(sprite_a, sprite_b):
    ...
    hitbox_x_ratio_a = (
        sprite_a["sprite_size"]["width"] / sprite_a["sprite"]["original size"]["width"]
    )
    hitbox_y_ratio_a = (
        sprite_a["sprite_size"]["height"]
        / sprite_a["sprite"]["original size"]["height"]
    )

    hitbox_x_ratio_b = (
        sprite_b["sprite_size"]["width"] / sprite_b["sprite"]["original size"]["width"]
    )
    hitbox_y_ratio_b = (
        sprite_b["sprite_size"]["height"]
        / sprite_b["sprite"]["original size"]["height"]
    )

    hit_a = Rect(
        sprite_a["position"]["x"]
        - (sprite_a["sprite_size"]["width"] / 2.0)
        + sprite_a["sprite"]["hitbox"]["x"] * hitbox_x_ratio_a,
        sprite_a["position"]["y"]
        - (sprite_a["sprite_size"]["height"] / 2.0)
        + sprite_a["sprite"]["hitbox"]["y"] * hitbox_y_ratio_a,
    ...
    hit_b = Rect(
        sprite_b["position"]["x"]
        - (sprite_b["sprite_size"]["width"] / 2.0)
        + sprite_b["sprite"]["hitbox"]["x"] * hitbox_x_ratio_b,
        sprite_b["position"]["y"]
        - (sprite_b["sprite_size"]["height"] / 2.0)
        + sprite_b["sprite"]["hitbox"]["y"] * hitbox_y_ratio_b,
